...
def main():
    ...
    try:
        left = pd.read_excel(lpath, sheet_name=args.sheet_left, engine=_excel_engine(lpath))
        right = pd.read_excel(rpath, sheet_name=args.sheet_right, engine=_excel_engine(rpath))
